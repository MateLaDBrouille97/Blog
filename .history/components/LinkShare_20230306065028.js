  ...
  return (
    <div className="link">
      ...
      >
        ...
        <form className="md:flex-none w-70 order-2 sm:order-1 flex justify-center py-4 sm:py-0 form__text work__form-text" onSubmit={handleSubmit}>
          <input
            type="text"
            className="work__form-text input-text"
            placeholder="Search..."
            value={query}
