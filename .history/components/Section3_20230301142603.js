  ...
  return (
    <section className="container mx-auto md:px-20 py-16">
      <div className="flex justify-center pb-8 mt-10 mb-20 section1__posts">
        <h1 className="font-bold text-4xl py-8 text-center section1__posts-title">Useful Hacks</h1>
      </div>
      ...
      <div className="flex justify-center pb-8 mt-10 mb-20 section1__posts">
        <button className="font-bold text-xl py-8 text-center section1__posts-title">View More</button>
      </div>
    </section>
  );
}
