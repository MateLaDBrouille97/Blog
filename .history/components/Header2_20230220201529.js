...
import blogData from "../pages/api/blogDataName";
      ...
      <nav className="nav container">
        ...
        <div className={!toggle ? "nav__menu show-menu" : "nav__menu"}>
          <ul className="nav__list grid">
            ...
            <li className="nav__item">
            <Link href={`/Categories/${blogData.name[0]}`} legacyBehavior>
              <a
                href="#usefulHacks"
            ...
            <li className="nav__item">
            <Link href={`/Categories/${blogData.name[1]}`} legacyBehavior>
              <a
                href="#portfolio"
            ...
            <li className="nav__item">
            <Link href={`/Categories/${blogData.name[2]}`} legacyBehavior>
              <a
                href="#contact"
