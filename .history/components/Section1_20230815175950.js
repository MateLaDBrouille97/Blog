...
export default function Section1() {
  ...
  const { blogUFH, blogP, blogN, blogO } = useBlogContext();
  ...
  const trending = [...blogList3, ...blogList1, ...blogList4, ...blogList2];
  ...
  return (
    <>
      <div className="flex flex-col overflow-hidden relative z-50 ">
        <div
          id="cover"
          className="cover-strip h-screen w-3/12 bg-slate-50  top-0 left-0 cover fixed h-6/5"
        ></div>
        <div
          id="cover1"
          className="cover-strip h-screen w-3/12 bg-slate-100 fixed top-0 left-1/4 cover h-6/5"
        ></div>
        <div
          id="cover2"
          className="cover-strip h-screen w-3/12 bg-slate-200 fixed top-0 left-2/4 cover h-6/5"
        ></div>
        <div
          id="cover3"
          className="cover-strip h-screen w-3/12 bg-slate-300 fixed top-0 left-3/4 cover h-6/5"
        ></div>
      </div>
