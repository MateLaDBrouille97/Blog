        ...
        <div class="col-div-6">
          ...
          <div className="cat flex gap-3 mb-4 ml-4">
            <Link href={`/Categories/${post?.category=="OPINIONS"?"NEWS":post?.category}`} legacyBehavior>
              <a className="text-orange-600 hover:text-orange-800 heading1">
              {post?.category || "UnKnown"}
              </a>
            </Link>
            <Link href="/" legacyBehavior>
              <a className="text-gray-600 hover:text-gray-800 blog-heading">{date || "UnKnown"}</a>
            </Link>
          </div>
          <div className="title mb-2 ml-4 text">
