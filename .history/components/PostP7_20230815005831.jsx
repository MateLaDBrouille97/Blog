...
export default function PostP7({post}) {
        ...
        <Link href={`/Posts/${post?.slug}`} legacyBehavior>
          <a className="postLine__img2">
            {!postImage ? (
              ...
              <Image src={postImage} alt="" width={450} height={300} className="postCol__img"/>
            )}
          </a>
        </Link>
      </div>
      <div className="info flex justify-center flex-col py-4">
      <div className="title postP7__container"></div>
        <div className="title">
          <Link href={`/Posts/${post?.slug}`} legacyBehavior>
            <a className="text-l md:text-l font-bold text-gray-800 hover:text-gray-600 postP7__title">
              {post?.title}
            </a>
          </Link>
        </div>
    ...
    <div className="image flex flex-col justify-start custom-image-wrapper3">
          <Link href={`/Posts/${post?.slug}`} legacyBehavior>
			...
			<h3 className="heading1">Entertainment</h3>
    ...
    <div className="image flex flex-col justify-start custom-image-wrapper3">
          <Link href={`/Posts/${post?.slug}`} legacyBehavior>
			...
			<h3 className="heading1">Animals</h3>
    ...
    <div className="image flex flex-col justify-start custom-image-wrapper3">
          <Link href={`/Posts/${post?.slug}`} legacyBehavior>
			...
			<h3 className="heading1">Photograpy</h3>
				<p className="blog-heading-1">Good Food Good Health</p>
				<p className="text">Lorem Ipsum is simply dummy text of the printing and typesetting </p>
				<span className="name">Manoj Singh . SEP 21, 2021</span>
		</div>
