    ...
    <footer className="footer">
      ...
      <div className="footer__container container">
        ...
        <ul className="footer__list">
          <li>
            <Link href={`https://blog2-eosin-beta.vercel.app/`} legacyBehavior>
          ...
          <li>
            <Link href={`https://blog2-eosin-beta.vercel.app/Categories/USEFULHACKS`} legacyBehavior>
              <a  className="footer__link">
                Useful Hacks
              </a>
            </Link>
          ...
          <li>
            <Link href={`https://blog2-eosin-beta.vercel.app/Categories/PROJECTS`} legacyBehavior>
              <a  className="footer__link">
                Projects
              </a>
            </Link>
          ...
          <li>
            <Link href={`https://blog2-eosin-beta.vercel.app/Categories/NEWS`} legacyBehavior>
              <a  className="footer__link">
                Techie's Society
              </a>
            </Link>
