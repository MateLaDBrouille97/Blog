...
function Section0() {
  ...
  <>
   <div className="flex flex-col overflow-hidden relative z-50 ">
    ...
    <section className=" section4 mx-auto md:px-20 py-16 w-5.5/6 ">
    
        <div className="main-section container-section4">
        <div className="main-section-zero container-section4">
          <div className="left">
            <div className="lnav">
