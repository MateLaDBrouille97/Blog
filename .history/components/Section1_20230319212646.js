...
export default function Section1() {
  ...
  const{blogUFH,
    ...
    const blogList1=blogUFH.length>1?blogUFH.slice(0, 2).sort((a, b) => {
        
      if (b.createdAt > a.createdAt) return 1
      if (b.createdAt< a.createdAt) return -1
  
      return 0
    }):blogUFH.slice(0, 1).sort((a, b) => {
    ...
    const blogList2=blogP.length>1?blogP.slice(0, 2).sort((a, b) => {
        
      if (b.createdAt > a.createdAt) return 1
      if (b.createdAt< a.createdAt) return -1
  
      return 0
    }):blogP.slice(0, 1).sort((a, b) => {
    ...
    const blogList3=blogN.length>1?blogN.slice(0, 2).sort((a, b) => {
        
      if (b.createdAt > a.createdAt) return 1
      if (b.createdAt< a.createdAt) return -1
  
      return 0
    }):blogN.slice(0, 1).sort((a, b) => {
