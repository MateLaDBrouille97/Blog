...
export default function PostColMultiple({ posts }) {
  ...
  return (
    <div className="section4__posts ">
      <div className="container2 grid m-3">
        <div className="box-1">
          <PostP7 post={allposts[0]} key={allposts?.[0]?.id} />
        </div>
        <div className="box-2 ">
          <div className="section4__posts m-4">
            <div className="flex flex-col gap-1 container5">
              {/* Post */}
              {allposts && allposts ? (
                allposts
                  .slice(1, 3)
      ...
      <div className="container4 grid ">
        <div className="section4__posts mt-3 container4 grid">
