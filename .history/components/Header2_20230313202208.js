          ...
          <ul className="nav__list grid">
            ...
            <li className="nav__item">
              <Link href={`/Categories/USEFULHACKS`} legacyBehavior>
                <a
                  href="https://blog-ten-lilac-20.vercel.app/Categories/USEFULHACKS"
                  onClick={() => setActiveNav("https://blog-ten-lilac-20.vercel.app/Categories/USEFULHACKS")}
                  className={
                    activeNav === "https://blog-ten-lilac-20.vercel.app/Categories/USEFULHACKS"
                      ? "nav__link active-link"
                      : "nav__link"
                  }
                >
            ...
            <li className="nav__item">
              <Link href={`/Categories/PROJECTS`} legacyBehavior>
                <a
                  href="https://blog-ten-lilac-20.vercel.app/Categories/PROJECTS"
                  onClick={() => setActiveNav("https://blog-ten-lilac-20.vercel.app/Categories/PROJECTS")}
                  className={
                    activeNav === "https://blog-ten-lilac-20.vercel.app/Categories/PROJECTS"
                      ? "nav__link active-link"
                      : "nav__link"
                  }
                >
            ...
            <li className="nav__item">
              <Link href={`/Categories/NEWS`} legacyBehavior>
                <a
                  href="https://blog-ten-lilac-20.vercel.app/Categories/NEWS"
                  onClick={() => setActiveNav("https://blog-ten-lilac-20.vercel.app/Categories/NEWS")}
                  className={
                    activeNav === "https://blog-ten-lilac-20.vercel.app/Categories/NEWS"
                      ? "nav__link active-link"
                      : "nav__link"
                  }
                >
                  <i className="uil uil-scenery nav__icon"></i>Tech News
                </a>
              </Link>
            </li>
          </ul>
