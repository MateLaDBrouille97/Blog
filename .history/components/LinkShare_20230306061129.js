  ...
  return (
    <div className="link">
      ...
      <div
        className={
          toggleState === true
            ? "md:flex-none w-70 order-2 sm:order-1 flex justify-center py-4 sm:py-0 show work__modal active-modal"
            : "md:flex-none w-70 order-2 sm:order-1 flex justify-center py-4 sm:py-0 invisible work__modal"
        }
      >
