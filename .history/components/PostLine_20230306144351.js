        ...
        <div className="info flex justify-center flex-col py-4 ">
          <div className="cat flex gap-6">
            <Link href={`/Categories/${post?.category}`} legacyBehavior>
              <a className="pl-2 text-orange-600 hover:text-orange-800">
          ...
          <div className="title">
            <Link href={`/Posts/${post?.slug}`} legacyBehavior>
              <a className=" postLine__title pl-2 text-3xl md:text-4xl font-bold text-gray-800 hover:text-gray-600">
                {post?.title}
              </a>
            </Link>
          </div>
          <p className="text-gray-500 py-3 pr-3 postCol3-description">{post?.description}</p>
