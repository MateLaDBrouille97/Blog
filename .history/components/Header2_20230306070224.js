        ...
        <div className={!toggle ? "nav__menu show-menu" : "nav__menu"}>
          <ul className="nav__list grid">
            ...
            <Link href={`/Categories/USEFULHACKS`} legacyBehavior>
              <a
                href="#usefulHacks"
                onClick={() => setActiveNav("/Categories/USEFULHACKS")}
                className={
                  activeNav === "/Categories/USEFULHACKS" ? "nav__link active-link" : "nav__link"
                }
              >
            ...
            <Link href={`/Categories/PROJECTS`} legacyBehavior>
              <a
                href="#projects"
                onClick={() => setActiveNav("={`/Categories/PROJECTS")}
                className={
                  activeNav === "={`/Categories/PROJECTS"
            ...
            <Link href={`/Categories/NEWS`} legacyBehavior>
              <a
                href="#news"
                onClick={() => setActiveNav("/Categories/NEWS")}
                className={
                  activeNav === "/Categories/NEWS"
                    ? "nav__link active-link"
                    : "nav__link"
                }
              >
