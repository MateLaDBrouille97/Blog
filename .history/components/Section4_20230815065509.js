        ...
        <div className="item">
            ...
            <div className="section4__posts">
              <div className="flex flex-col gap-1">
                {/* Post */}
                {dataSort4 && dataSort4 ? (
                  <PostColMultiple posts={dataSort4} />
                ) : (
                  <></>
                )}
              </div>
            ...
            <div className="section3__view">
              <Link href={`/Categories/ANALYSIS`} legacyBehavior>
          ...
          <div className="item ">
            ...
            <div className="section4__posts">
              <div className="flex flex-col gap-1">
                {/* Post */}
                {dataSort && dataSort ? (
                  <PostColMultiple posts={dataSort} />
                ) : (
                  <></>
                )}
              </div>
          ...
          <div className="item">
            ...
            <div className="section4__posts">
              <div className="flex flex-col gap-1">
                {/* Post */}
                {dataSort2 && dataSort2 ? (
                  <PostColMultiple posts={dataSort2} />
                ) : (
                  <></>
                )}
              </div>
          ...
          <div className="item">
            ...
            <div className="section4__posts">
              <div className="flex flex-col gap-1">
                {/* Post */}
                {dataSort3 && dataSort3 ? (
                  <PostColMultiple posts={dataSort3} />
                ) : (
                  <></>
                )}
              </div>
            ...
            <div className="section3__view">
              <Link href={`/Categories/OPINIONS`} legacyBehavior>
                <a className="font-bold text-xl py-8 text-center section3__view-title">
                  {" "}
                  View More
                </a>
