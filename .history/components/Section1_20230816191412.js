...
export default function Section1() {
  ...
  return (
    <>
      ...
      <section className="section py-16 trending__container background-img" id="section1">
      <div className="post__article-blog2" />
        <div className="container mt-10 mx-auto md:px-20 content content-v2 " style={bg}>
