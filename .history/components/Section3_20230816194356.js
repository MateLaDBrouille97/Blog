...
export default function Section3() {
  ...
  return (
    <>
      ...
      <section className="section  trending__container mx-auto md:px-20 py-16 background-img2">

        <div className="container flex justify-center pb-8 mt-10 mb-20 section3__posts">
