...
import Post3col from "./Post3Col";

export default function Section4() {
  const {  blogP, blogN} = useBlogContext();
  ...
  return (
    <>
      <section className="section section4 mx-auto md:px-20 py-16 w-6/7">
        <div className="container">
          <div className="grid lg:grid-cols-3 container__section4 ">
