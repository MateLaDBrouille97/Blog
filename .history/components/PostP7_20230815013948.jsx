        ...
        <div class="col-div-6">
          <div class="box-1">
            ...
            <p class="text">
              ...
              industry. Lorem Ipsum has been the Beautiful Location For Travel
            </p>
            <p class="text">
              Lorem Ipsum is simply dummy text of the printing and typesetting
              industry.{" "}
            </p>
            <span class="name">Manoj Singh . SEP 21, 2021</span><div className="info flex justify-center flex-col py-4">
