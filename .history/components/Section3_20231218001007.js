    ...
    <>
      <section className="section section4 mx-auto md:px-20 py-16 w-5.5/6 background-img2">
        <div className="container-section4 ">
          ...
          <div className="section3__container2 flex justify-center items-center">
            <div className="swiper-container grid md:grid-cols-1 lg:grid-cols-2 gap-14 justify-center">
              <Swiper
