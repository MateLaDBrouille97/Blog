    ...
    <Format>
      <section className="section mx-auto md:px-2 py-16 w-1/2">
        ...
        <div className="container ">
          ...
          <h1 className="font-bold text-4xl text-begin pb-5 article__title">{post?.title}</h1>
          <p className="text-gray-500 text-2xl text-begin article__subtitle"> {post?.subtitle}</p>
