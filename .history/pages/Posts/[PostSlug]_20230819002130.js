...
function Article({ image, post, post2 }) {
  ...
  return (
    <Format>
      ...
      <section className="section mx-3 section4 mx-auto md:px-20 py-16 w-5.5/6 flex ">
        <div className="section__article-postSlug container-section4 flex justify-center items-center flex-column">
