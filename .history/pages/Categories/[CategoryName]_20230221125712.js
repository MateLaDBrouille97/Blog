  ...
  return (
    <Format>
      <section className="container mx-auto md:px-2 py-16 w-1/2">
        <div className="post py-10 flex flex-row justify-begin item-center category__header">
          <div className="py-10 flex justify-center item-center" >
            <Image src={category?.image} alt="" width={120} height={80} priority/>
          </div>
          <h1 className="py-30 font-bold flex flex-col justify-center item-center text-4xl text-center pb-5 ">{category?.name}</h1>
