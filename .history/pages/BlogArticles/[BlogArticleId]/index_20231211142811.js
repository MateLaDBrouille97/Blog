      ...
      <section className="section  mt-20 section section4 mx-auto md:px-20 py-16 lg:w-4/6 md:w-5.25/6 ">
        <div className="container-section4 ">
          ...
          <div className="section__cat container-section4">
            ...
            <h2 className="article__text content relative">
              <div className="h-full ">
                ...
                <div className="hidden md:flex h-full w-80 flex-col inset-y-0 absolute top-0 bottom-0">
                  {blogArticle && (
                    <BlogArticleSidebar
                      blogarticle={blogArticle}
                      onSelectChapter={handleSelectChapter}
                ...
                <main className="md:pl-80 pt-[-80px] h-full  absolute top-4">
                  {selectedChapter ? (
                    <ChapterIdPage
